...
export const ALL_WORKSPACE_FEATURES: WorkspaceFeatureMeta[] = [
  ...
  {
    id: 'focus_shield',
    defaultLabel: 'Focus Shield Pro',
    shortDescription: 'OLED App Quotas, Automated Study Schedules, Reels Blocker & Avatar Studio.',
    category: 'core',
    categoryLabel: 'Core Daily Tools',
    iconName: 'Shield',
    badge: 'PRO',
    suggestedReason: 'Enforces pure focus with scheduled slots, app limits, and rewards.',
    defaultActive: true,
    defaultOrder: 5,
  },
  ...
  },
  {
    ...
    shortDescription: 'Install StudyRide on your Android device for hardware-level focus shielding.',
    category: 'resources_perks',
    categoryLabel: 'Perks & Membership',
    iconName: 'Download',
    badge: 'APK',
    suggestedReason: 'Get the full StudyRide mobile experience with background focus shield.',
    defaultActive: false,
    defaultOrder: 24,
  },
];
