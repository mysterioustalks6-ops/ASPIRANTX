...
export const StudentDashboard: React.FC<StudentDashboardProps> = ({ 
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6">
      {/* HEADER BANNER */}
      <div className="ax-card p-4 sm:p-6 border-slate-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-100">Welcome back, {userProfile.name}</h1>
          <div className="flex items-center gap-2 text-slate-400 text-xs sm:text-sm mt-1.5 flex-wrap">
        ...
        <div className="flex items-center space-x-3 bg-slate-950 px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border border-slate-800 w-full sm:w-auto justify-center sm:justify-start">
          ...
          <div>
            ...
            <div className="text-sm sm:text-base font-bold text-slate-100">{(userProfile.streakDays || data.currentStreak || 1)} Days</div>
          </div>
        </div>
      </div>
      ...
      {/* DAILY STUDY SUMMARY NUDGE WIDGET (Wallpaper-style calm card) */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="ax-card p-4 sm:p-5 space-y-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 sm:gap-2.5 pt-1">
          {getActiveFeaturesInOrder(workspaceConfig).map((item) => (
            <button
              ...
              className="p-2.5 sm:p-3 rounded-xl bg-slate-950/80 hover:bg-indigo-950/40 border border-slate-800 hover:border-indigo-500/50 transition-all text-left group flex flex-col justify-between h-20 shadow-sm"
            >
