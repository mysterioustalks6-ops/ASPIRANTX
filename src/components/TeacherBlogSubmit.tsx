      ...
      <div className="min-h-screen bg-slate-950 p-6 flex items-center justify-center">
        <div className="bg-slate-900 border border-sky-500/30 rounded-3xl p-8 sm:p-10 max-w-xl w-full text-center shadow-2xl animate-fadeIn">
          ...
          <p className="text-slate-300 text-sm mb-6 leading-relaxed">
            Thank you <strong>{request.teacherName}</strong>. Your article <span className="text-sky-300 font-bold">"{submittedPost.title}"</span> has been submitted to the StudyRide editorial desk. Once approved, it will be published live on the public Blog.
          </p>
...
Write paragraph details here...`}
        ...
        <div className="pt-4 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-xs text-slate-400 flex items-center gap-2">
            ...
            <span>Submitted posts will be reviewed by StudyRide admin before publishing.</span>
          </div>
