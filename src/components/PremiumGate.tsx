      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center p-6 bg-slate-950/70 backdrop-blur-sm">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-slate-300 mt-1 max-w-xs mx-auto">
              This feature has been designated as a <strong className="text-amber-300">PRO Pass</strong> feature by the StudyRide Administrator.
            </p>
          </div>
