            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1 pr-6">
                ...
                <h2 className="text-xl sm:text-2xl font-black text-white tracking-tight">
                  Make StudyRide Your Live Wallpaper
                </h2>
                ...
                <div className="space-y-3">
                  <div className="p-3.5 rounded-2xl bg-emerald-950/40 border border-emerald-500/40 flex items-center gap-3">
                    ...
                    <div className="text-xs text-emerald-200">
                      <p className="font-bold">StudyRide is your active Live Wallpaper!</p>
                ...
                {showOemDetails && (
                  <div className="mt-1.5 p-3 rounded-xl bg-slate-950 border border-slate-800/80 text-[11px] text-slate-300 space-y-2">
                    {oemBrand.includes('vivo') ? (
                      <p>
                        <strong>Vivo (Funtouch OS / OriginOS):</strong> If the live wallpaper picker does not show directly, long press your home screen &rarr; select <em>Wallpapers</em> &rarr; <em>Live Wallpapers</em> &rarr; choose <em>StudyRide</em>.
                      </p>
                    ) : oemBrand.includes('xiaomi') || oemBrand.includes('redmi') || oemBrand.includes('poco') ? (
                      <p>
                        <strong>Xiaomi (MIUI / HyperOS):</strong> Long press home screen &rarr; tap Wallpaper &rarr; Live Wallpapers &rarr; select StudyRide. Enable Autostart in Security app if you wish notifications to fire reliably.
                      </p>
                    ) : oemBrand.includes('samsung') ? (
                      <p>
                        <strong>Samsung (One UI):</strong> Long press home screen &rarr; <em>Wallpaper and style</em> &rarr; <em>Change wallpapers</em> &rarr; <em>Live Wallpapers</em> &rarr; choose <em>StudyRide</em>.
                      </p>
                    ) : oemBrand.includes('oppo') || oemBrand.includes('realme') || oemBrand.includes('oneplus') ? (
                      <p>
                        <strong>Oppo / Realme / OnePlus (ColorOS / OxygenOS):</strong> Long press home screen &rarr; Wallpapers &rarr; Live &rarr; select StudyRide.
                      </p>
                    ) : (
                      <p>
                        <strong>Stock Android / Pixel / Motorola:</strong> Long press home screen &rarr; Wallpaper &amp; style &rarr; Live Wallpapers &rarr; select StudyRide.
                      </p>
                    )}
                    <button
                      onClick={handleOpenOemSettings}
