      ...
      <section className="max-w-6xl mx-auto px-6 pt-12 pb-20 text-center relative z-10">
        ...
        >
          <button
            ...
            disabled={loading}
            className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 hover:brightness-110 text-slate-950 font-black text-sm flex items-center justify-center gap-3 shadow-2xl shadow-cyan-500/30 transition-all duration-200"
          >
