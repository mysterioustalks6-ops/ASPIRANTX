...
export const ExamWallpaperWidget: React.FC<ExamWallpaperWidgetProps> = ({
  ...
  const generateAndDownloadWallpaper = async () => {
    ...
    try {
      ...
      const filename = `StudyRide_${activeExam}_${selectedPersona.id}_Wallpaper.png`;
      ...
      if (Capacitor.isNativePlatform()) {
        try {
          ...
          await Share.share({
            ...
            text: `StudyRide ${cleanExamTitle} countdown and progress wallpaper`,
            url: savedFile.uri,
            ...
            >
              ...
              <div className="space-y-2.5 mb-4">
                {(oemInfo?.isVivoDevice ? [
                  ...
                  { step: 5, icon: '⚡', title: 'StudyRide Select Karein', desc: 'List mein "StudyRide" dhundhein aur select karein, phir "Set Wallpaper" tap karein' },
                ] : oemInfo?.isXiaomiDevice ? [
                  ...
                  { step: 5, icon: '⚡', title: 'StudyRide Select Karein', desc: 'StudyRide wallpaper pe tap karein aur "Apply" karein' },
                ] : [
                  ...
                  { step: 4, icon: '⚡', title: 'StudyRide Chunein', desc: 'List mein StudyRide dhundhein aur "Set Wallpaper" karein' },
              ...
              <div className="bg-indigo-500/10 border border-indigo-500/30 rounded-xl p-2.5 mb-4">
                <p className="text-[11px] text-indigo-300 font-medium">
                  💡 <strong>Tip:</strong> StudyRide live wallpaper already install hai aur ready hai — sirf system picker se select karna hai.
                </p>
              </div>
