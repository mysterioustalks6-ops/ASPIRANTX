...
export const GamificationBar: React.FC<GamificationBarProps> = ({ 
  ...
  return (
    <>
      ...
      <div className="w-full bg-slate-900/90 border-b border-slate-800/80 px-3 sm:px-6 py-2 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 text-xs backdrop-blur-md">
        {/* Level & XP Progress Section */}
        <div className="flex items-center gap-2.5 flex-1 max-w-md min-w-0">
          <div className="flex items-center gap-1 px-2 py-1 rounded-xl bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border border-purple-500/30 text-purple-300 shrink-0 font-extrabold text-[11px]">
          ...
          <div className="flex-1 min-w-0 space-y-1">
            ...
            {/* Level Progress Bar */}
            <div className="w-full h-1.5 sm:h-2 rounded-full bg-slate-950 border border-slate-800 overflow-hidden relative">
              <div
        ...
        <div className="flex items-center justify-between sm:justify-end gap-2 shrink-0">
          ...
          {onOpenReferralModal && (
            <button
              ...
              className="px-2.5 py-1 rounded-xl bg-gradient-to-r from-amber-500/15 via-orange-500/15 to-purple-500/15 hover:from-amber-500/25 hover:to-purple-500/25 border border-amber-500/30 text-amber-300 font-extrabold text-[11px] flex items-center gap-1 transition-all shadow-sm shrink-0"
