...
export const GamificationBar: React.FC<GamificationBarProps> = ({ 
  ...
  return (
    <>
      ...
      <div className="w-full bg-slate-900/90 border-b border-slate-800/80 px-4 sm:px-6 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs backdrop-blur-md">
        {/* Level & XP Progress Section */}
        <div className="flex items-center gap-3 min-w-[240px] flex-1 max-w-md">
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border border-purple-500/30 text-purple-300 shrink-0 font-extrabold">
          ...
          <div className="flex-1 min-w-0 space-y-1">
            <div className="flex items-center justify-between text-[11px] font-bold">
              ...
              <span className="text-slate-400 text-[10px]">
                {xpNeededForNextLevel} XP to Lvl {level + 1}
              </span>
            </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          {onOpenReferralModal && (
            <button
              ...
              className="px-3 py-1 rounded-xl bg-gradient-to-r from-amber-500/15 via-orange-500/15 to-purple-500/15 hover:from-amber-500/25 hover:to-purple-500/25 border border-amber-500/30 text-amber-300 font-extrabold text-[11px] flex items-center gap-1.5 transition-all shadow-sm"
          ...
          {/* Coins Balance Pill */}
          <div className="flex items-center gap-2 px-3 py-1 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-300 font-extrabold">
          ...
          {isPremiumActive ? (
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 border border-emerald-500/40 text-emerald-300 font-bold">
              <Crown className="w-3.5 h-3.5 text-emerald-400 fill-emerald-400" />
              <span>1-Day PRO Unlocked</span>
            </div>
          ) : (
            <button
              ...
              className="px-3.5 py-1 rounded-xl bg-gradient-to-r from-amber-500 via-orange-500 to-amber-400 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-black text-[11px] flex items-center gap-1.5 shadow-md shadow-amber-500/20 transition-all"
            >
              <Zap className="w-3.5 h-3.5 fill-slate-950" /> Redeem PRO (100 Coins)
            </button>
          )}
        </div>
      </div>
